    ...
    public partial class Form1 : Form
    {
        ...
        private void btnAgregarAlumno_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string respuesta = objConexion.administrarDatos(alumnos, accion);
                if (respuesta != "1")
                {
        ...
        private void btnEliminarAlumno_Click(object sender, EventArgs e)
        {
            ...
            {
                String respuesta = objConexion.administrarDatos(new String[] {idALumno.Text, "", "", "", ""}, "Eliminar");
        ...
        private void grbDatosAlumnos_Enter(object sender, EventArgs e)
        {

        }

        private void grbEdicionAlumnos_Enter(object sender, EventArgs e)
        {
